...
For all error codes returned when **creating** a session (e.g. contract already signed, payment already done), see [Create Checkout Session — Error Responses](/api-reference/checkout-sessions/create-session#error-responses).
