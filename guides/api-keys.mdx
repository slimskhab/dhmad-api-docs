...
- Ensure you're using the correct key for your environment: `sk_live_` for production (`api.dhmad.tn`), `sk_sandbox_` for the [sandbox](/guides/sandbox) (`sandbox.dhmad.tn`). Using the wrong key type returns a clear 401 message.
