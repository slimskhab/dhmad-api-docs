...
- An API key (see [Getting Started](/docs/getting-started))
...
See the [Webhooks Guide](/docs/guides/webhooks) for detailed setup instructions.
...
- **[Error Handling](/docs/api-reference/errors)** - Learn about error responses
- **[Best Practices](/docs/guides/best-practices)** - Production-ready tips
