...
<ParamField response="session.action" type="string">
  The action type: `sign_contract`, `accept_pay`, `complete`, `dispute`, `request_cancellation`, `reject_cancellation`, `accept_cancellation`, `cancel_escrow`, `submit_proof`, `review_proof`, `add_funds`, or `refund_funds`
</ParamField>
