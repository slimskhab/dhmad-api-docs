...
**Instant escrow – sign_contract not allowed**

```json
{
  "error": "Bad Request",
  "message": "Instant escrows do not use a contract. Use action 'accept_pay' to get a checkout URL for payment."
}
```

**Instant escrow – complete not allowed**

```json
{
  "error": "Bad Request",
  "message": "Instant escrows auto-complete when you call the deliver endpoint. Use action 'accept_pay' for the buyer checkout."
}
```
