...
- **[Overview](/api-reference/escrows/overview)** - Introduction to escrows and statuses
...
These endpoints use developer JWT authentication (not API key). Manage them via the [Developer Dashboard](https://developer.dhmad.tn/dashboard) or the Developer Portal API.
...
- `PUT /api/developer/webhooks/:id` - Update a webhook
