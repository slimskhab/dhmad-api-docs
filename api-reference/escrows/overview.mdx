...
<CardGroup cols={2}>
  ...
  <Card title="paid" icon="check">
    Payment received and locked in escrow. The buyer can release funds via a `complete` checkout session (early release), or the seller can call deliver first (optional).
  </Card>
