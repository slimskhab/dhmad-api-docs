...
Only the **buyer** can perform this action, and the escrow must be in `delivered` status. A [charge](/api-reference/charges/overview) id returns **409** `CHARGE_NOT_AN_ESCROW`.
